...
public class CarrinhoDAO {
	...
	static {
		Produto videogame = new Produto(6237, "Videogame PS4", 4000, 1);
		Produto esporte = new Produto(3467, "Jogo de esporte", 60, 4);
		Carrinho carrinho = new Carrinho();
		carrinho.adiciona(videogame);
		carrinho.adiciona(esporte);
		carrinho.para("Rua Vergueiro 3185, 8 andar", "São Paulo");
		carrinho.setId(1l);
